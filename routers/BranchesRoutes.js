...
//Updated route: Get all branches for a specific company
router.get("/company/:companyId", getBranchesByCompany); // GET to `/api/v1/branches/` for getting all branches
